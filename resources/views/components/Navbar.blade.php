                ...
                <li class="dropdown pc-h-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-end pc-h-dropdown">
                        <a href="#!" class="dropdown-item" onclick="layout_change('dark')"><svg class="pc-icon">
                            ...
                            <span>Escuro</span> </a><a href="#!" class="dropdown-item"
                            onclick="layout_change('light')"><svg class="pc-icon">
                                <use xlink:href="#custom-sun-1"></use>
                            </svg>
                            <span>Claro</span> </a><a href="#!" class="dropdown-item"
                            onclick="layout_change('light')"><svg class="pc-icon">
                ...
                <li class="dropdown pc-h-item">
                    ...
                    <div class="dropdown-menu dropdown-notification dropdown-menu-end pc-h-dropdown">
                        <div class="dropdown-header d-flex align-items-center justify-content-between">
                            ...
                            <a href="#!" class="btn btn-link btn-sm">Marcar como lidas</a>
                        </div>
                        <div class="dropdown-body text-wrap header-notification-scroll position-relative"
                            style="max-height: calc(100vh - 215px)">
                            <p class="text-span">Hoje</p>
                            <div class="card mb-2">
                                <div class="card-body">
                                    <div class="d-flex">
                        ...
                        <div class="text-center py-2">
                            <a href="#!" class="link-danger">Limpar todas notificações</a>
                        </div>
                    </div>
                </li>
                        ...
                        <div class="dropdown-body">
                            <div class="profile-notification-scroll position-relative"
                                ...
                                <div class="d-flex mb-1">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h6 class="mb-1"> {{ session('nome_utilizador') }}</h6>
                                        <span><a href="#" class="__cf_email__">
                                                {{ session('email_utilizador') }}</a></span>
                                    </div>
                                </div>
